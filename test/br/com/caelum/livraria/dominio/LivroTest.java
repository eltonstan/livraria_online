...
public class LivroTest {
	...
	private static final Autor autor = new Autor(umAutor);
	public static final Livro UM_LIVRO = new Livro("nome do livro", autor, umIsbnValido, VALOR_DO_LIVRO);
	public static final Livro OUTRO_LIVRO = new Livro("outro nome do livro", autor, outroIsbnValido, VALOR_DO_LIVRO);
